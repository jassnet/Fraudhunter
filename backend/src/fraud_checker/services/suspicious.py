...
from ..api_presenters import present_click_finding_record, present_conversion_finding_record
...
def get_click_findings(
    ...
    *,
    ...
    resolved_date = resolve_target_date(repo, "click_ipua_daily", target_date)
...
def get_click_detail(
    ...
    *,
    ...
    payload = present_click_finding_record(
        row,
        details,
