...
DEFAULT_FRAUD_CHECK_MIN_TOTAL = 10
DEFAULT_FRAUD_CHECK_INVALID_RATE = 30
DEFAULT_FRAUD_CHECK_DUPLICATE_PLID_COUNT = 3
DEFAULT_FRAUD_CHECK_DUPLICATE_PLID_RATE = 10
DEFAULT_FRAUD_TRACK_MIN_TOTAL = 20
DEFAULT_FRAUD_TRACK_AUTH_ERROR_RATE = 5
DEFAULT_FRAUD_TRACK_AUTH_IP_UA_RATE = 50
DEFAULT_FRAUD_ACTION_MIN_TOTAL = 10
DEFAULT_FRAUD_ACTION_SHORT_GAP_SECONDS = 5
DEFAULT_FRAUD_ACTION_SHORT_GAP_COUNT = 3
DEFAULT_FRAUD_ACTION_CANCEL_RATE = 30
DEFAULT_FRAUD_ACTION_FIXED_GAP_MIN_COUNT = 3
DEFAULT_FRAUD_ACTION_FIXED_GAP_MAX_UNIQUE = 2
DEFAULT_FRAUD_SPIKE_MULTIPLIER = 3
DEFAULT_FRAUD_SPIKE_LOOKBACK_DAYS = 7
